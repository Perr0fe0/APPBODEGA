...
public class Principal extends javax.swing.JFrame {
    ...
    private void VerdespachoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VerdespachoActionPerformed
        VerDespacho abrirVentana = new VerDespacho();
        escritorio.add(abrirVentana);
        abrirVentana.show();
    }//GEN-LAST:event_VerdespachoActionPerformed

    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        EliminarProd abrirVentana= new EliminarProd();
        escritorio.add(abrirVentana);
        abrirVentana.show();
        BarraMenu.hide();
    ...
    private void ListaProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ListaProdActionPerformed
        ...
        ListarProductos abrirVentana = new ListarProductos();
        escritorio.add(abrirVentana);
        abrirVentana.show();
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        // TODO add your handling code here:
        VerEstadosdespacho abrirVentana = new VerEstadosdespacho();
        escritorio.add(abrirVentana);
        abrirVentana.show();
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        // TODO add your handling code here:
        ListarDespacho abrirVentana = new ListarDespacho();
        escritorio.add(abrirVentana);
        abrirVentana.show();
